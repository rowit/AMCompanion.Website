...
angular.module("amCompanion").controller("FullLoginController", ['$scope', '$timeout', '$location', 'AuthService', 'RoutesService', function ($scope, $timeout, $location, AuthService, RoutesService) {
    "use strict";
    var that = this;
